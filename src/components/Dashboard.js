    ...
    <div className="flex min-h-screen bg-[#151d30] p-6">
      ...
      <div className="flex flex-col w-full ml-6 mt-8">
        ...
        <div className="flex flex-row gap-6">
          {/* Graph section */}
          <div className="flex-1 bg-[#1b233a] p-6 rounded-2xl shadow-lg border border-[#4a5473] h-full w-full">
        ...
        <div className="flex flex-row gap-6 mt-4">
          <div className="flex-[3.5] bg-[#1b233a] p-6 rounded-2xl shadow-lg border border-[#4a5473] w-full h-full">
            <h2 className="text-xl font-semibold text-white mb-4">
              Recent Transactions
            </h2>
          ...
          {/*busniess branches*/}
          <div className="flex-1 bg-[#1b233a] p-6 rounded-2xl shadow-lg border border-[#4a5473] w-80 h-full">
